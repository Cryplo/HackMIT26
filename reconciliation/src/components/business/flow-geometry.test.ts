...
const layouts: { width: number; boxes: Record<FlowNode, NodeBox> }[] = [
  { width: 1000, boxes: { sources: box(0, -150, 1000, 150), waiting: box(26, 26, 240, 240), checking: box(310, 26, 240, 240), investigations: box(26, 310, 524, 250), passed: box(594, 26, 380, 170), uncertain: box(594, 208, 380, 170), failed: box(594, 390, 380, 170) } },
  { width: 700, boxes: { sources: box(0, -150, 1000, 150), waiting: box(18, 22, 300, 215), checking: box(356, 22, 316, 215), investigations: box(18, 275, 654, 250), passed: box(18, 563, 211, 186), uncertain: box(239, 563, 211, 186), failed: box(460, 563, 212, 186) } },
  { width: 360, boxes: { sources: box(0, -150, 1000, 150), waiting: box(36, 22, 308, 176), checking: box(36, 230, 308, 190), investigations: box(36, 452, 308, 260), passed: box(36, 744, 308, 156), uncertain: box(36, 932, 308, 156), failed: box(36, 1120, 308, 156) } },
];
