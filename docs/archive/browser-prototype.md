# Historical browser-agent prototype

> Historical project, separate from the current Sift reimbursement app. Commands below run from the repository root. Start with the [current project context](../PROJECT_CONTEXT.md) for Sift.
