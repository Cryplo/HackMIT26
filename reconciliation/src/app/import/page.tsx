  ...
  return (
    <main className="min-h-dvh bg-muted/40 text-foreground">
      <nav aria-label="Main navigation" className="flex h-16 items-center justify-between border-b border-border bg-background px-4 sm:px-8">
        <Link href="/overview" className="flex items-center gap-2 text-sm font-semibold"><ScanLine className="size-5" aria-hidden="true" />Sift</Link>
        <Button asChild variant="ghost"><Link href="/overview"><ArrowLeft aria-hidden="true" />Audit overview</Link></Button>
      </nav>
