...
The added cohort contains 24 flights, 18 train trips, 12 bus trips, and 12 hotel stays. It varies names, dates, origins, merchants, totals, and references, with supported amount/cap issues and matching, missing, or conflicting bookings. Use ordinary live checks to determine results; no saved outcomes are injected.
