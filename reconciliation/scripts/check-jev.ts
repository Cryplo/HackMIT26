...
async function main() {
if (process.argv.includes('--workflow')) throw new Error('The legacy workflow smoke test is retired; use the reviewed rule-testing flow instead. No model calls were made.');
